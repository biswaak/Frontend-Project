...
import { FlashShopProducts } from "./FlashshopProduct";
import { FashionShopProdutDetails } from "./FlashshopProductdetails";
            ...
            <section className="mt-2 row">
                ...
                <main className="col-9">
                    <Routes>
                        ...
                        <Route path="products/:category" element={<FlashShopProducts/> } />
                        <Route path="details/:id" element={<FashionShopProdutDetails/>} />
